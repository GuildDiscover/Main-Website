...
export const topServers = [
  {
    ...
    language: "English",
    country: "Malaysia",
    logo: "https://i.ibb.co/S6y4S6c/Guildiscover-logo.png",
    status: "New",
    rating: 4,
    moderator_review:
...
export const features = [
  {
    icon: <AppstoreOutlined style={{ fontSize: "60px", color: "#4CAF50", padding: "30px" }} />,
    title: "Discover Amazing Communities",
    description:
      "Explore a diverse range of communities on Guildiscover, from gaming to anime, writing to arts. Find the perfect match for your interests and connect with like-minded individuals.",
  },
  {
    icon: <TeamOutlined style={{ fontSize: "60px", color: "#2196F3", padding: "30px" }} />,
    title: "Safety Ensured",
    description:
      "Our moderation team thoroughly scans all communities to ensure a safe environment for everyone. Join servers with confidence, knowing your safety is our top priority.",
  },
  {
    icon: <GlobalOutlined style={{ fontSize: "60px", color: "#FFC107", padding: "30px" }} />,
    title: "Secure Platform",
    description:
      "We prioritize your security with a trusted platform built on strict security policies and advanced web security methods, ensuring a safe and enjoyable experience.",
  },
];
