...
function ServerDetails({ servers }) {
  ...
  >
    <div style={{ padding: "20px" }}>
      ...
      <Row gutter={16}>
        <Col span={12}>
          <Card title={<span style={{ color: "#fff"}}>Server Description</span>}
            bordered={false} style={{ marginBottom: "20px" , background: "#2d2e36", color: "#fff" }}>
            <Text style={{ color: "#fff" }}>{server.long_description}</Text>
          </Card>
        </Col>

        <Col span={12}>
        <Card title={<span style={{ color: "#fff"}}>Server Information</span>} bordered={false} style={{ marginBottom: "20px" , background: "#2d2e36", color: "#fff" }}>
          ...
          <Card title={<span style={{ color: "#fff"}}>Moderator Revieqw</span>} bordered={false} style={{ marginTop: "10px", background: "#2d2e36" }}>
