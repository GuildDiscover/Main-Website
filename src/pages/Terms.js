...
const Terms = () => {
  return (
    <Content style={{ padding: "50px", backgroundColor: "#f0f2f5" }}>
      ...
      <Paragraph style={{ textAlign: "left", color: "#555", fontSize: "16px" }}>
      By using Guildiscover, you agree to:
				  <ul class="unordered-list">
				    <li>Not use the Website for any unlawful purposes.</li>
				    <li>Not use the Website for any commercial purposes without prior written permission from Guildiscover.</li>
				    <li>Not upload content that is harmful, defamatory, obscene, or violates any third-party rights.</li>
      ...
      <Paragraph style={{ textAlign: "left", color: "#555", fontSize: "16px" }}>
        ...
        <br></br>
        <strong>Guildiscover</strong>
          <li>Website: https://guildiscover.jst-tan.page</li>
          <li>Discord Server: https://discord.gg/z7DC9tTyEH</li>
      </Paragraph>
    </Content>
  );
};
