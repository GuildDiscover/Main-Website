...
const teamMembers = [
  { name: "Jst Tan", role: "Founder & Developer", description: "Jst Tan is the founder, a lead developer, and the main face of the Guildiscover platform, leading the Guildiscover team with vision and dedication. With a deep commitment to the community, Jst Tan ensures Guildiscover continues to thrive.", image: "https://i.ibb.co/bNky98t/logo.jpg" },
  { name: "Wakjawa", role: "Designer & Little Knowledge in Law", description: "Wakjawa is a talented designer at Guildiscover who also brings legal expertise as a law student. Alongside design work, Wakjawa assists with all law-related matters, supporting both creative and compliance areas.", image: "https://i.ibb.co/fQVS7MW/Wakjawa-Logo.png" },
  { name: "Ash1729", role: "Developer", description: "Ash1729 is a key web developer at Guildiscover and the primary architect behind the platform itself. Ash1729 stands out as one of the team’s top developers and is the most active member.", image: "https://i.ibb.co/fnJRhN5/Ash-Logo.png" },
...
const Team = () => {
  return (
    <Content style={{ padding: "50px", background: "linear-gradient(#80ED99, #45DF81, #0AD1C8, #14919B, #0B6477, #213A57", padding: "50px 20px" }}>
      <div style={{
          textAlign: "center",
          padding: "40px",
      ...
      Guildiscover is made by a passionate and motivated team, with the project is made with the assistance by all of the team members. 
      <br></br>
        ...
        {teamMembers.map((member, index) => (
          <Col xs={24} sm={12} md={6} key={index}>
            ...
            style={{
              ...
              <Title level={3} style={{color: "#fff", marginTop: "10px" }}>{member.name}</Title>
              <h3>{member.role}</h3>
